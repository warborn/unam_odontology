<button type="button" class="btn btn-primary catalog" id="subject-btn">Agregar Asignatura</button>

<div class="modal fade" id="subject-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
