...
<div class="row">
	...
	<div class="col-sm-12 col-md-4 col-lg-4 form-group">
		{{Form::label('Nombre del servicio medico')}} : {{Form::select('medical_service',['0' => 'Seleccione', 'IMSS' => 'IMSS', 'ISSSTE' => 'ISSSTE'],$patient->medical_service,['class' => 'form-control', 'disabled'])}}
	</div>
